        ...
        <header className="w-full flex justify-center text-sm pt-4">
            <div
                ...
                <div>
                    ...
                    <button
                        className="relative bg-gradient-to-b z-[-2] from-[#64C7F2] to-[#0B658C] px-3 py-2 rounded-lg">
                        <div
...
function Testimonials() {
    const images = Array(5).fill("/TestimonialCard.png");
    ...
    return (
        <section className="relative flex justify-center items-center w-full px-8 pt-20 pb-10 z-0">
            ...
            <div className="flex w-5/6 justify-between z-0 overflow-hidden max-h-[700px]">
                {['scroll-down', 'scroll-up', 'scroll-down'].map((animation, columnIndex) => (
                    <div key={columnIndex} className="flex flex-col items-center gap-[2px]">
                        <div className="relative h-[700px]">
                            {images.map((src, index) => (
                                <Image
                                    key={index}
                                    className={`min-w-[400px] ${animation} animation-delay-${index * 2}s`}
                                    src={src}
                                    alt="Testimonial"
                                    width={400}
                                    height={320}
