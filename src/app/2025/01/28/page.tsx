...
export default function Page() {
    ...
    return <>
        <Canvas style={{position: "absolute", top: "0", zIndex: "196791360"}}>
            <Scene/>
            <OrbitControls />
        </Canvas>
    </>
...
function Scene() {
    ...
    return <>
        <Html
            position={[-2.5, 0, 0]}
            scale={0.25}
            rotation={[-Math.PI * 0.4, 0, -Math.PI * 0.1]}
            center
            transform>
            <WebPage/>
        </Html>
        <mesh position={[0, 0, 1.5]} renderOrder={1}>
            <boxGeometry args={[0.5, 0.5, 0.5, 1]}/>
            <meshBasicMaterial color="#24f318"/>
        </mesh>
        <Html position={[0, 0, -2.5]} transform scale={0.5}>
...
function WebPage() {
    return (
        <div
            className={twMerge("absolute w-[1000px] h-[700px] overflow-scroll top-0 z-10 bg-white text-[#0b0c14]", inter.variable)}>

            <div className="absolute w-full h-[55%] top-0 z-[-5] p-2
                bg-[radial-gradient(circle,_#38bdf9_0%,_#ffffff_40%)]"/>
            <Image
                src="/grain.png"
                alt="grain overlay"
                width={1240}
            ...
            <div className="absolute w-full h-[55%] z-[-4] p-2
                bg-[radial-gradient(circle,_#0b0c1429_0%,_#ffffff_40%)]"/>
            <Header/>
            <HeroSection/>
        ...
        <header className="w-full flex justify-center text-sm pt-4">
            <div
                ...
                <nav className="flex items-center gap-3">
                    <div className="bg-none border-none mx-2">
                        Matthew Haar
                    </div>
                </nav>
                <div className="flex items-center justify-center">
                    <button className="bg-none border-none mx-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line x1="3" y1="6" x2="21" y2="6" stroke="#0b0c14" strokeLinecap="round" strokeWidth="2"/>
                            <line x1="3" y1="12" x2="21" y2="12" stroke="#0b0c14" strokeLinecap="round"
                                  strokeWidth="2"/>
                            <line x1="3" y1="18" x2="21" y2="18" stroke="#0b0c14" strokeLinecap="round"
                                  strokeWidth="2"/>
                        </svg>
                    </button>
                </div>
    ...
    return (
        <section className="flex flex-col items-center px-8 pt-20 pb-10">
            ...
            <div className="flex justify-center gap-4 my-4">
                <button
                    className="relative bg-gradient-to-b z-[-2] from-[#64C7F2] to-[#0B658C] px-6 py-3 rounded-xl overflow-hidden">
