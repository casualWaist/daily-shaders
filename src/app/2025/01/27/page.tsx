...
export default function Page() {
    return (
        <div className={twMerge("absolute w-full top-0 z-10 bg-white text-[#0b0c14]", inter.variable)}>
                ...
                <div className="flex items-center justify-center">
                    <button className="bg-none border-none mx-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <line x1="3" y1="12" x2="21" y2="12" stroke="#0b0c14" strokeLinecap="round" strokeWidth="2"/>
                            <line x1="3" y1="18" x2="21" y2="18" stroke="#0b0c14" strokeLinecap="round" strokeWidth="2"/>
                        </svg>
                    </button>
                </div>
            </div>
