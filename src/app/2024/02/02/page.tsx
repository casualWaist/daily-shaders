...
const VertTingle = shaderMaterial({
        time: 0,
...
declare module "@react-three/fiber" {
    interface ThreeElements {
        vertTingle: MaterialNode<any, any>
    }
}
...
const Shader = forwardRef(({ ...props }: Props, ref) => {
    ...
    return <vertTingle key={VertTingle.key} ref={localRef} {...props} attach='material' />
})
