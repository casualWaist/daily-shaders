...
const RayIMMERShaderImp = shaderMaterial({
    uTime: 0,
    uScroll: 0.00001,
...
extend({ RayIMMERShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            rayIMMERShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type RayIMMERShaderUniforms = {
    uTime?: number
    uScroll?: number
...
type Props = RayIMMERShaderUniforms & MaterialProps

const RayIMMERShader = forwardRef<RayIMMERShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <rayIMMERShaderImp key={RayIMMERShaderImp.key} ref={localRef} attach="material" {...props} />
})
RayIMMERShader.displayName = 'RayIMMERShader'
