...
const Melt24ShaderImp = shaderMaterial({
    uTime: 0,
    uScroll: 0.00001,
...
extend({ Melt24ShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            melt24ShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type Melt24ShaderUniforms = {
    uTime?: number
    uScroll?: number
...
type Props = Melt24ShaderUniforms & MaterialProps

const Melt24Shader = forwardRef<Melt24ShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <melt24ShaderImp key={Melt24ShaderImp.key} ref={localRef} attach="material" {...props} />
})
Melt24Shader.displayName = 'Melt24Shader'
...
function Scene({props}: {props?: JSX.IntrinsicElements['mesh']}) {
    ...
    return <>
        <mesh position={[0, 0, 0]} {...props}>
            ...
            {/* @ts-ignore */}
            <Melt24Shader ref={shaderRef} uTexture={faceTex}/>
        </mesh>
