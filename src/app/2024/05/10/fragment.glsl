...
void main(){
    ...
    gl_FragColor = vec4(finalColor + lineColor * fadePos * glowColor * (orgMoTex * 10.0) - pow(hotSpot, 4.0), finalColor.r - flareSpot - flareSpotB);
    //gl_FragColor = vec4(finalColor + lineColor * fadePos * (orgMoTex * 10.0) - pow(hotSpot, 4.0), finalColor.r);
