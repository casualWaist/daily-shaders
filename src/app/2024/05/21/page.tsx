...
const A24ShaderImp = shaderMaterial({
    uTime: 0,
    uScroll: 0.00001,
...
declare global {
    namespace JSX {
        interface IntrinsicElements {
            a24ShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type A24ShaderUniforms = {
    uTime?: number
    uScroll?: number
...
type Props = A24ShaderUniforms & MaterialProps

const A24Shader = forwardRef<A24ShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <a24ShaderImp key={A24ShaderImp.key} ref={localRef} attach="material" {...props} />
})
A24Shader.displayName = 'A24Shader'
