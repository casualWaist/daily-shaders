...
const Blob24ShaderImp = shaderMaterial({
    uTime: 0,
    uScroll: 0.00001,
...
extend({ Blob24ShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            blob24ShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type Blob24ShaderUniforms = {
    uTime?: number
    uScroll?: number
...
type Props = Blob24ShaderUniforms & MaterialProps

const Blob24Shader = forwardRef<Blob24ShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <blob24ShaderImp key={Blob24ShaderImp.key} ref={localRef} attach="material" {...props} />
})
Blob24Shader.displayName = 'Blob24Shader'
