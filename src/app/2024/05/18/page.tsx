...
const RayIShaderImp = shaderMaterial({
    uTime: 0,
    uScroll: 0.00001,
...
extend({ RayIShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            rayIShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type RayIShaderUniforms = {
    uTime?: number
    uScroll?: number
...
type Props = RayIShaderUniforms & MaterialProps

const RayIShader = forwardRef<RayIShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <rayIShaderImp key={RayIShaderImp.key} ref={localRef} attach="material" {...props} />
})
RayIShader.displayName = 'RayIShader'
