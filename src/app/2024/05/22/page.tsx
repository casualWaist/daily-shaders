...
const Another24ShaderImp = shaderMaterial({
    uTime: 0,
    uScroll: 0.00001,
...
extend({ Another24ShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            another24ShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type Another24ShaderUniforms = {
    uTime?: number
    uScroll?: number
...
type Props = Another24ShaderUniforms & MaterialProps

const Another24Shader = forwardRef<Another24ShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <another24ShaderImp key={Another24ShaderImp.key} ref={localRef} attach="material" {...props} />
})
Another24Shader.displayName = 'Another24Shader'
