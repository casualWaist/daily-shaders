...
const MarchFireShaderImp = shaderMaterial({
    uTime: 0,
...
extend({ MarchFireShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            marchFireShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}
...
const MarchFireShader = forwardRef(({...props}: Props, ref) => {
    ...
    return <marchFireShaderImp key={MarchFireShaderImp.key} ref={localRef} attach="material" {...props} />
})
MarchFireShader.displayName = 'MarchFireShader'
