...
const BubbleShaderImp = shaderMaterial({
    uTime: 0,
...
extend({ BubbleShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            bubbleShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type BubbleShaderUniforms = {
    uTime: number
...
type Props = BubbleShaderUniforms & MaterialProps

const BubbleShader = forwardRef<BubbleShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <bubbleShaderImp key={BubbleShaderImp.key} ref={localRef} attach="material" {...props} />
})
