...
function Scene() {
    ...
    const tGeo = useGLTF('/EmergencePointCloud.glb') as GLTFResult
    ...
    return <>
        ...
        <group position={[0, -.5 * (view.width / 11.0), 0]} rotation={[Math.PI * 0.5, 0, 0]}>
            <points ref={points} scale={ 1.5 * (view.width / 11.0) }>
