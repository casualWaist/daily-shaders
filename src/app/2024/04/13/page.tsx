...
const HalfFirstShaderImp = shaderMaterial({
    uTime: 0,
...
extend({ HalfFirstShaderImp })

declare global {
    namespace JSX {
        interface IntrinsicElements {
            halfFirstShaderImp: MaterialNode<any, typeof THREE.MeshStandardMaterial>
        }
    }
}

export type HalfFirstShaderUniforms = {
    uTime: number
...
type Props = HalfFirstShaderUniforms & MaterialProps

const HalfFirstShader = forwardRef<HalfFirstShaderUniforms, Props>(({...props}: Props, ref) => {
    ...
    return <halfFirstShaderImp key={HalfFirstShaderImp.key} ref={localRef} attach="material" {...props} />
})
HalfFirstShader.displayName = 'HalfFirstShader'
