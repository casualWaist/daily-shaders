...
void main() {
    ...
    modelPositionA.y += sin(modelPositionA.x * uBigWavesFrequency.x + uTime * uBigWavesSpeed);
    modelPositionB.y += sin(modelPositionB.x * uBigWavesFrequency.x + uTime * uBigWavesSpeed);
